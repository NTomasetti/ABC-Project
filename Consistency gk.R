...
s1=function(x, qr) 1/T*sum(x^2)
s2=function(x, qr) (1/T*sum((x-s1(x, qr))^2))^0.5
s3=function(x, qr) 1/T*sum((x-s1(x, qr))^3)/((1/T*sum((x-s1(x, qr))^2))^1.5)
s4=function(x, qr) (1/T*sum((x-s1(x, qr))^4)/((1/T*sum((x-s1(x, qr))^2))^2))^0.5
